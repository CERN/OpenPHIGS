 ...
 * \brief Deletes all elements within and on the bounds of the given range.  The element pointer is left pointing to the element just prior to the first element deleted.
 */

 ...
 * \brief Deletes all elements in the structure that lie between the given labels, but not the labels themselves.  The element pointer is left pointing to the first label.
 */

...
static void priv_fill_area_points(
                                  Pint num_vertices,
                                  Ppoint3 *points
                                  )
{
...
static void priv_fill_area_ptcolrs(
                                   Ws *ws,
                                   Pint colr_type,
                                   Pint num_vertices,
                                   Pptco3 *ptcolrs,
...
static void priv_back_area_ptcolrs(
                                   Ws *ws,
                                   Pint colr_type,
                                   Pint num_vertices,
                                   Pptco3 *ptcolrs,
...
static void priv_fill_area_ptconorms(
                                     Ws *ws,
                                     Pint colr_type,
                                     Pint num_vertices,
...
static void priv_back_area_ptconorms(
                                     Ws *ws,
                                     Pint colr_type,
                                     Pint num_vertices,
                                     Pptconorm3 *ptconorms,
  ...
  case PVERT_COORD:
    if (fasd3.fflag == PFACET_COLOUR_NORMAL) {
      ...
      for (i = 0; i < fasd3.nfa; i++) {
        priv_fill_area_points(fasd3.vdata->num_vertices,
      ...
      Pint colr_type = wsgl_get_int_colr(ast)->type;
                                  ...
                                  )
{
  ...
  case PVERT_COORD:
    if (fasd3.fflag == PFACET_COLOUR_NORMAL) {
      ...
      Pint colr_type = wsgl_get_back_int_colr(ast)->type;
